...
const Calendar = ({ choosenDate, setChoosenDate, handlePrevMonth, handleNextMonth, currentYear, currentMonth, flexibleCurrentMonth, daysArray, days }) => {
    ...
    return (
        <div className="calendar">
            ...
            <div className='grid'>
                ...
                {daysArray.map(day =>
                    <div
                        onClick={() => setChoosenDate(day.format('DD.MM.YYYY'))}
                        className=
                        {
                            day.isoWeekday() == 6 || day.isoWeekday() == 7
                                ? choosenDate == day.format('DD.MM.YYYY')
